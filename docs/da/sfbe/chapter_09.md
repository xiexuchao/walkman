...
### 9.3 总体均值: σ已知
  ...
  * z≤-z<sub>α/2</sub>或z≥z<sub>α/2</sub>拒绝原假设
  ...
  注意: 
  我们已经展示了如何使用p值。 越小的p值越大的证明反对H<sub>0</sub>，有更多证据倾向赞成H<sub>a</sub>. 
  这里有一些统计学家关于解释较小的p值的指导建议:
  * 小于0.01: 压倒性的证据推断H<sub>a</sub>是真的
  * 0.01到0.05: 强烈的证据推断H<sub>a</sub>是真的
  * 0.05到0.10: 比较弱的证据推断H<sub>a</sub>是真的
  * 比0.1大: 不充足证据推断H<sub>a</sub>是真的
  
### 9.4 总体均值: σ未知
  这一节我们描述如何对总体均值在σ未知的情况下进行假设检验。 因为σ未知情况相应于那些对总体标准方差不能比样本优越的开发估计出来的情况， 样本必须用于估计总体均值μ和总体标准方差σ. 因此，要对总体均值在σ未知的情况下进行假设检验， 样本均值x̄用于估计μ以及样本标准方差s用于对总体标准方差σ.
  在8.2节，我们展示了总体均值在σ未知的情况下的区间估计是基于一种称为t分布的概率分布。 对于σ未知情况，检验统计具有t分布， 具有n-1的自由度。
